...
from .fp4_mla import (FLASHINFER_FP4_MLA_ATTENTION_BACKEND_ENV,
...
class FlashInferAttentionMetadata(AttentionMetadata):
    ...
    def _allocate_fp4_mla_buffers(self, buffers, capture_graph: bool) -> None:
        ...
        buffers used by ``fp4_mla.update_hp_kv_for_fp4_mla``."""
    ...
    def prepare(self) -> None:
        ...
        # (fp4_mla.update_hp_kv_for_fp4_mla). Only active when MLA + NVFP4.
        if self.high_precision_kv_pool is not None:
